...
public static class SyscallPermissions
{
    public static bool TryGetRequiredPermission(SyscallId id, out string permission)
    {
        permission = id switch
        {
            ...
            SyscallId.UiDrawPolyline => "ui",
            SyscallId.UiDrawPolygon => "ui",
            SyscallId.UiDrawTextPath => "ui",
            SyscallId.UiDrawRectPaint => "ui",
            SyscallId.UiDrawEllipsePaint => "ui",
            SyscallId.UiDrawPolylinePaint => "ui",
            SyscallId.UiDrawPolygonPaint => "ui",
            SyscallId.UiDrawPathPaint => "ui",
            SyscallId.UiDrawTextPaint => "ui",
            SyscallId.UiFilterBlur => "ui",
            SyscallId.UiGroupPush => "ui",
            SyscallId.UiGroupPop => "ui",
            SyscallId.UiTranslate => "ui",
            SyscallId.UiScale => "ui",
            SyscallId.UiRotate => "ui",
