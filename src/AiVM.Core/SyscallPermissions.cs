...
public static class SyscallPermissions
{
    public static bool TryGetRequiredPermission(SyscallId id, out string permission)
    {
        permission = id switch
        {
            ...
            SyscallId.WorkerStart => "process",
            SyscallId.WorkerPoll => "process",
            SyscallId.WorkerResult => "process",
            SyscallId.WorkerError => "process",
            SyscallId.WorkerCancel => "process",
            SyscallId.DebugEmit => "debug",
            SyscallId.DebugMode => "debug",
            SyscallId.DebugCaptureFrameBegin => "debug",
            SyscallId.DebugCaptureFrameEnd => "debug",
            SyscallId.DebugCaptureDraw => "debug",
            SyscallId.DebugCaptureInput => "debug",
            SyscallId.DebugCaptureState => "debug",
            SyscallId.DebugReplayLoad => "debug",
            SyscallId.DebugReplayNext => "debug",
            SyscallId.DebugAssert => "debug",
            SyscallId.DebugArtifactWrite => "debug",
            SyscallId.DebugTraceAsync => "debug",
