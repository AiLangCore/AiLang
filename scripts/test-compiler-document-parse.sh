    ...
    Fn#test_f2(params=args) {
      Block#test_b2 {
        Let#test_l3(name=validProgram) {
          Call#test_c2(target=compiler.parse) {
        ...
        If#test_if1 {
          ...
          Block#test_b4 { Return#test_r2 { Call#test_c3(target=fail) { Lit#test_i5(value="compiler.parse valid document failed") } } }
        }
        ...
        If#test_if2 {
          ...
          Block#test_b6 { Return#test_r3 { Call#test_c5(target=fail) { Lit#test_i9(value="compiler.parse accepted trailing document input") } } }
        }
        If#test_if3 {
          Eq#test_e4 {
          ...
          Block#test_b8 { Return#test_r4 { Call#test_c6(target=fail) { Lit#test_i13(value="compiler.parse trailing input code failed") } } }
        }
