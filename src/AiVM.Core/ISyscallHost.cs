...
public interface ISyscallHost
{
    ...
    void UiDrawTextPath(int windowHandle, string path, string text, string color, int size);
    void UiDrawRectPaint(int windowHandle, int x, int y, int width, int height, string fill, string stroke, int strokeWidth, int opacity);
    void UiDrawEllipsePaint(int windowHandle, int x, int y, int width, int height, string fill, string stroke, int strokeWidth, int opacity);
    void UiDrawPolylinePaint(int windowHandle, string points, string stroke, int strokeWidth, int opacity);
    void UiDrawPolygonPaint(int windowHandle, string points, string fill, string stroke, int strokeWidth, int opacity);
    void UiDrawPathPaint(int windowHandle, string path, string fill, string stroke, int strokeWidth, int opacity, int closed);
    void UiDrawTextPaint(int windowHandle, int x, int y, string text, string color, int size, int opacity);
    void UiFilterBlur(int windowHandle, string path, string color, int strokeWidth, int radius, int opacity, int closed);
    void UiGroupPush(int windowHandle);
    void UiGroupPop(int windowHandle);
    void UiTranslate(int windowHandle, int dx, int dy);
    void UiScale(int windowHandle, int sx, int sy);
    void UiRotate(int windowHandle, int degrees);
