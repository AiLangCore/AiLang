...
- `compiler/aic.aos`: compiler driver (`fmt`, `check`, `run`, `test`).
- `compiler/format.aos`: canonical formatter.
- `compiler/validate.aos`: structural validator.
- `std/*.aos`: minimal standard library modules.
