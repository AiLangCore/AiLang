...
static int emit_wasm_spa_files(const char* out_dir)
{
    ...
    }
    {
        ...
        const char* main_js_head2 =
            ...
            "  const state = { host, svg, width, height, frameParts: [], nextElementId: 1, focusedTargetId: '', eventQueue: [], lastPolledEvent: { type: 'none', targetId: '', x: -1, y: -1, key: '', text: '', modifiers: '', repeat: false } };\n"
