...
for opcode in NODE_KIND NODE_ID VALUE_KIND TO_STRING STR_ESCAPE STR_SUBSTRING STR_FIND ATTR_VALUE_KIND ATTR_VALUE_BOOL MAKE_LIT_BOOL MAKE_NODE_EMPTY MAKE_PAIR PAIR_FIRST PAIR_SECOND; do
