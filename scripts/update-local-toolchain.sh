...
copy_if_exists "${AILANG_DIR}/.artifacts/ailang-linux-arm64/aivm-runtime" "${TMP_ROOT}/runtimes/linux-arm64/aivm-runtime"
copy_if_exists "${AILANG_DIR}/.artifacts/ailang-linux-arm64/aivectra-x11" "${TMP_ROOT}/runtimes/linux-arm64/aivectra-x11"
copy_if_exists "${AILANG_DIR}/.artifacts/ailang-linux-arm64/aivectra-framebuffer" "${TMP_ROOT}/runtimes/linux-arm64/aivectra-framebuffer"
...
find "${TMP_ROOT}/runtimes" -type f -name 'aivm-runtime' -exec chmod +x {} +
find "${TMP_ROOT}/runtimes" -type f -name 'aivectra' -exec chmod +x {} +
