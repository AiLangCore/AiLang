...
public static class VmSyscalls
{
    ...
    public static void UiDrawTextPath(int windowHandle, string path, string text, string color, int size)
    {
        Host.UiDrawTextPath(windowHandle, path, text, color, size);
    }

    public static void UiDrawRectPaint(int windowHandle, int x, int y, int width, int height, string fill, string stroke, int strokeWidth, int opacity)
    {
        Host.UiDrawRectPaint(windowHandle, x, y, width, height, fill, stroke, strokeWidth, opacity);
    }

    public static void UiDrawEllipsePaint(int windowHandle, int x, int y, int width, int height, string fill, string stroke, int strokeWidth, int opacity)
    {
        Host.UiDrawEllipsePaint(windowHandle, x, y, width, height, fill, stroke, strokeWidth, opacity);
    }

    public static void UiDrawPolylinePaint(int windowHandle, string points, string stroke, int strokeWidth, int opacity)
    {
        Host.UiDrawPolylinePaint(windowHandle, points, stroke, strokeWidth, opacity);
    }

    public static void UiDrawPolygonPaint(int windowHandle, string points, string fill, string stroke, int strokeWidth, int opacity)
    {
        Host.UiDrawPolygonPaint(windowHandle, points, fill, stroke, strokeWidth, opacity);
    }

    public static void UiDrawPathPaint(int windowHandle, string path, string fill, string stroke, int strokeWidth, int opacity, int closed)
    {
        Host.UiDrawPathPaint(windowHandle, path, fill, stroke, strokeWidth, opacity, closed);
    }

    public static void UiDrawTextPaint(int windowHandle, int x, int y, string text, string color, int size, int opacity)
    {
        Host.UiDrawTextPaint(windowHandle, x, y, text, color, size, opacity);
    }

    public static void UiFilterBlur(int windowHandle, string path, string color, int strokeWidth, int radius, int opacity, int closed)
    {
        Host.UiFilterBlur(windowHandle, path, color, strokeWidth, radius, opacity, closed);
    }

    public static void UiGroupPush(int windowHandle)
    {
        Host.UiGroupPush(windowHandle);
    }

    public static void UiGroupPop(int windowHandle)
    {
        Host.UiGroupPop(windowHandle);
    }

    public static void UiTranslate(int windowHandle, int dx, int dy)
    {
        Host.UiTranslate(windowHandle, dx, dy);
    }

    public static void UiScale(int windowHandle, int sx, int sy)
    {
        Host.UiScale(windowHandle, sx, sy);
    }

    public static void UiRotate(int windowHandle, int degrees)
    {
        Host.UiRotate(windowHandle, degrees);
    }
