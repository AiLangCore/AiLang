...
PROCESS_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/vm_c_execute_src_process_start_unsupported.aos"
FS_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_fs_file_read.aos"
NET_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_net_tcp_connect.aos"
UI_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_ui_draw_rect.aos"
UI_POLL_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_ui_poll_event.aos"
UI_SIZE_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_ui_get_window_size.aos"
IMAGE_WARN_CASE="${AIVM_C_TESTS_DIR}/golden/parity_cases/wasm_profile_warn_image_decode.aos"
...
for CASE_NAME in "${CASES[@]}"; do
  CASE_PATH="${AIVM_C_TESTS_DIR}/golden/parity_cases/${CASE_NAME}.aos"
...
"${AILANG_CLI}" publish "${AIVM_C_TESTS_DIR}/golden/parity_cases/vm_c_execute_src_main_params.aos" --target wasm32 --wasm-profile spa --out "${PUBLISH_SPA_DIR}" >/dev/null
"${AILANG_CLI}" publish "${AIVM_C_TESTS_DIR}/golden/parity_cases/vm_c_execute_src_main_params.aos" --target wasm32 --wasm-profile fullstack --out "${PUBLISH_FULLSTACK_DIR}" >/dev/null
