...
printf '%s\n' "${OUT}" | rg -Fqx 'Object(format="AiBCO1" modulePath="src/app.aos" version=1) { Import(path="dep.aos") Const(kind="int" value=0) Export(name="start" symbol="src/app.aos::start") Symbol(kind="function" name="start" symbol="src/app.aos::start") Function(name="start" symbol="src/app.aos::start" params="args" locals="args") { Inst(op="STORE_LOCAL" a=0) Inst(op="CONST" a=0) Reloc(kind="const" instruction=1 target="int:0") Inst(op="RETURN") } }'
