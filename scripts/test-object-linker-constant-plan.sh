  ...
  Let(name=start) {
    Fn() {
      Block {
        ...
        If { Eq { ChildCount { Var(name=constants) } Lit(value=3) } Block { Lit(value=0) } Block { Return { Lit(value=1) } } }
        ...
        If { Eq { AttrValueInt { ChildAt { Var(name=second) Lit(value=0) } Lit(value=0) } Lit(value=1) } Block { Lit(value=0) } Block { Return { Lit(value=5) } } }
        If { Eq { AttrValueInt { ChildAt { Var(name=second) Lit(value=1) } Lit(value=0) } Lit(value=2) } Block { Return { Lit(value=0) } } Block { Return { Lit(value=6) } } }
      }
    }
  }
}
